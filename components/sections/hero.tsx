...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      {/* 🌑 Black gradient overlay (NO white haze) */}
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-20 md:py-32 max-w-6xl mx-auto">
        <div className="text-center space-y-8">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold text-white text-balance leading-tight mb-4">
              Your First Step Into Cybersecurity
            </h1>

            <p className="text-lg text-gray-200 max-w-2xl mx-auto text-balance mb-6">
          ...
          <div className="flex flex-col gap-2 items-center">
            <p className="text-sm text-gray-300">
              Instant PDF download after payment • Secure Cashfree Checkout
            </p>
          </div>
